...
if __name__ == "__main__":
    ...
    with open('result.csv', 'a', newline='') as csvfile:
        ...
        result_writer.writerow(
            ["Waiting_Time_Type", "Teta", "Mu", "Lambda", "Analysis_type", "PB", "PD", "PD1", "PD2"])
        ...
        while True:
            ...
            for arrival_rate in arrival_rates:
                for waiting_time_type in waiting_time_types:
                    ...
                    simulation_pb, simulation_pd, simulation_pd1, simulation_pd2 = simulator.simulate(waiting_time,
                                                                      service_rate,
                                                                      problem_size,
                    ...
                    result = [waiting_time_type, waiting_time, service_rate,
                              arrival_rate, "Simulation", simulation_pb, simulation_pd, simulation_pd1, simulation_pd2]
